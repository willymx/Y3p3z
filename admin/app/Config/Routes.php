...
$routes->group('', function($routes) {
    $routes->get('/', 'Cotizador::index', ['as' => 'index']);
...
// ================================================
// RUTAS DEL COTIZADOR ACUMULADORES YÉPEZ
// ================================================
$routes->group('cotizador', function($routes) {
    $routes->get('/', 'Cotizador::index', ['as' => 'cotizador']);
    $routes->post('buscar', 'Cotizador::buscar', ['as' => 'cotizadorBuscar']);
    $routes->post('registrar', 'Cotizador::registrar_venta', ['as' => 'cotizadorRegistrar']);
});

// APIs para autocompletado
$routes->group('api', function($routes) {
    $routes->get('marcas', 'Cotizador::getMarcas', ['as' => 'apiMarcas']);
    $routes->get('modelos/(:segment)', 'Cotizador::getModelos/$1', ['as' => 'apiModelos']);
    $routes->get('anios/(:segment)/(:segment)', 'Cotizador::getAnios/$1/$2', ['as' => 'apiAnios']);
    $routes->get('test-db', 'Cotizador::testDatabase', ['as' => 'testDatabase']);
});