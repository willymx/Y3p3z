                ...
                <div class="action">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end border">
                            <li>
                                <a  href="<?= route_to('chatProfile') ?>" class="dropdown-item rounded text-secondary-light bg-hover-neutral-200 text-hover-neutral-900">
        ...
        <div class="chat-main card">
            ...
            <div class="chat-empty">
                <div class="text-center">
                    <img src="<?= base_url('assets/images/chat/empty-img.png') ?>" alt="image">
