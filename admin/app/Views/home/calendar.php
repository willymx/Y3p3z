                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <div class=" position-relative">
                                            <input class="form-control radius-8 bg-base" id="startDate" type="text" placeholder="03/12/2025, 10:30 AM">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <div class=" position-relative">
                                            <input class="form-control radius-8 bg-base" id="endDate" type="text" placeholder="03/12/2025, 2:30 PM">
                                            <span class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1">
                                                <iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon>
                                            </span>
                                        </div>
                    ...
                    <div class="modal-content radius-16 bg-base">
                        ...
                        <div class="modal-body p-24">
                            ...
                            <div class="mb-12">
                                ...
                                <h6 class="text-primary-light fw-semibold text-md mb-0 mt-4">25 Jan 2025, 10:30AM</h6>
                            </div>
                            <div class="mb-12">
                                <span class="text-secondary-light txt-sm fw-medium">End Date</span>
                                <h6 class="text-primary-light fw-semibold text-md mb-0 mt-4">25 Jan 2025, 2:30AM</h6>
                            </div>
                            <div class="mb-12">
                            ...
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <div class=" position-relative">
                                            <input class="form-control radius-8 bg-base" id="editstartDate" type="text" placeholder="03/12/2025, 10:30 AM">
                                            <span class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1">
                                                <iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <div class=" position-relative">
                                            <input class="form-control radius-8 bg-base" id="editendDate" type="text" placeholder="03/12/2025, 2:30 PM">
                                            <span class="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1">
                                                <iconify-icon icon="solar:calendar-linear" class="icon text-lg"></iconify-icon>
                                            </span>
                                        </div>
